"""
Django settings for AEula project.
...
SECRET_KEY = 'django-insecure-&x0m78-9%8)^sg((-9(vxr(u%@mc+goff^((68p^-08#3u-^wp'
...
WSGI_APPLICATION = 'AEula.wsgi.application'
